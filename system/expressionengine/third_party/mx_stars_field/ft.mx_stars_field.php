...
class Mx_stars_field_ft extends EE_Fieldtype
{
    ...
    {
        parent::EE_Fieldtype();
        $this->EE->lang->loadfile(MX_STARS_FIELD_KEY);
    ...
    public function display_field($data)
    {
        if (!isset($this->cache[__CLASS__]['header'])) {
            $this->EE->cp->add_to_head('<script type="text/javascript" src="' . $this->EE->config->item('theme_folder_url') . 'third_party/mx_stars_field/js/jquery-ui-1.8.5.custom.min.js"></script>');
            $this->EE->cp->add_to_head('<script type="text/javascript" src="' . $this->EE->config->item('theme_folder_url') . 'third_party/mx_stars_field/js/jquery.ui.stars.min.js"></script>');
            $this->EE->cp->add_to_head('<link rel="stylesheet" type="text/css" href="' . $this->EE->config->item('theme_folder_url') . 'third_party/mx_stars_field/css/ui.stars.css" />');
    ...
    {
        if (!isset($this->EE->session->cache[__CLASS__]['mx_stars_js'])) {
            $this->EE->cp->add_to_head('<script type="text/javascript" src="' . $this->EE->config->item('theme_folder_url') . 'third_party/mx_stars_field/js/jquery-ui-1.8.5.custom.min.js"></script>');
            $this->EE->cp->add_to_head('<script type="text/javascript">mx_stars_field = {}; </script>');
            $this->EE->cp->add_to_head('<script type="text/javascript" src="' . $this->EE->config->item('theme_folder_url') . 'third_party/mx_stars_field/js/jquery.ui.stars.min.js"></script>');
            $this->EE->cp->add_to_head('<link rel="stylesheet" type="text/css" href="' . $this->EE->config->item('theme_folder_url') . 'third_party/mx_stars_field/css/ui.stars.css" />');
            $this->EE->cp->add_to_foot('<script type="text/javascript" src="' . $this->EE->config->item('theme_folder_url') . 'third_party/mx_stars_field/js/mx_stars.js"></script>');
            $this->EE->session->cache[__CLASS__]['mx_stars_js'] = true;
        }
        ;
        ...
        $this->EE->cp->add_to_foot('<script type="text/javascript">mx_stars_field["col_id_' . $this->col_id . '"] = "' . $split . '"</script>');
    ...
    {
        $this->EE->lang->loadfile('mx_stars_field');
        ...
        $this->EE->table->add_row(lang('stars', 'stars'), $this->select_list($prefix . '_field_stars', $field_stars));
        $this->EE->table->add_row(lang('split', 'split'), $this->select_list($prefix . '_split', $field_split));
    }
    ...
    {
        return array(
            'mx_stars_field_field_stars' => $this->EE->input->post('mx_stars_field_field_stars'),
            'mx_stars_field_split' => $this->EE->input->post('mx_stars_field_split')
        );
    }
    // --------------------------------------------------------------------
